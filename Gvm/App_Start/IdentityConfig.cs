...
namespace Gvm
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            if (int.TryParse(ConfigurationManager.AppSettings["MaxFailedAccessAttemptsBeforeLockout"], out maxFailedAccessAttemptsBeforeLockout) == false)
                maxFailedAccessAttemptsBeforeLockout = 3;

            int defaultAccountLockoutTimeSpan;
            if (int.TryParse(ConfigurationManager.AppSettings["DefaultAccountLockoutTimeSpan"], out defaultAccountLockoutTimeSpan) == false)
